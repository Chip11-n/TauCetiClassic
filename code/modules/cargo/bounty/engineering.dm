...
/datum/bounty/item/engineering/cyborg_charger
	name = "Cell Charger"
	description = "We don't have enough cell rechargers to fit all of our battaries for BSA. Ship us one of yours."
	reward = CARGO_CRATE_VALUE * 5
	wanted_types = list(/obj/machinery/cell_charger = TRUE)

/datum/bounty/item/engineering/cyborg_charger
	name = "Recharger"
	description = "We are preparing for a new tournament. Ship us one of yours."
	reward = CARGO_CRATE_VALUE * 5
